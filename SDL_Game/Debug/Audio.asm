; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.21005.1 
	...
	TITLE	F:\Finished_Projects\PROJECT_FILES\WhiteNoise\James Robertson SDL Final\SDL_Game\SDL_Game\Audio.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?audioCallback@aud@@YAXPAXPAEH@Z		; aud::audioCallback
PUBLIC	??0audio@aud@@QAE@XZ				; aud::audio::audio
PUBLIC	?sfxSelect@audio@aud@@QAEX_N@Z			; aud::audio::sfxSelect
PUBLIC	?loadAudio@audio@aud@@QAEXV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z ; aud::audio::loadAudio
PUBLIC	?playAudio@audio@aud@@QAEXXZ			; aud::audio::playAudio
PUBLIC	?pauseAudio@audio@aud@@QAEXXZ			; aud::audio::pauseAudio
...
EXTRN	_atexit:PROC
EXTRN	_SDL_memcpy:PROC
EXTRN	_SDL_RWFromFile:PROC
EXTRN	_SDL_OpenAudio:PROC
EXTRN	_SDL_PauseAudio:PROC
EXTRN	_SDL_MixAudio:PROC
...
_audio_pos DD	01H DUP (?)
_audio_len DD	01H DUP (?)
_BSS	ENDS
CRT$XCU	SEGMENT
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File f:\finished_projects\project_files\whitenoise\james robertson sdl final\sdl_game\sdl_game\audio.cpp
;	COMDAT ?pauseAudio@audio@aud@@QAEXXZ
_TEXT	SEGMENT
_this$ = -8						; size = 4
?pauseAudio@audio@aud@@QAEXXZ PROC			; aud::audio::pauseAudio, COMDAT
; _this$ = ecx
...
; 83   : }
	...
	pop	ebp
	ret	0
?pauseAudio@audio@aud@@QAEXXZ ENDP			; aud::audio::pauseAudio
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File f:\finished_projects\project_files\whitenoise\james robertson sdl final\sdl_game\sdl_game\audio.cpp
;	COMDAT ?playAudio@audio@aud@@QAEXXZ
_TEXT	SEGMENT
_this$ = -8						; size = 4
?playAudio@audio@aud@@QAEXXZ PROC			; aud::audio::playAudio, COMDAT
; _this$ = ecx
...
; 56   : 	if (sfx)
	...
	movzx	ecx, BYTE PTR [eax+64]
	test	ecx, ecx
	je	SHORT $LN2@playAudio

; 57   : 	{
; 58   : 		wav_spec.callback = audioCallback;

	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+52], OFFSET ?audioCallback@aud@@YAXPAXPAEH@Z ; aud::audioCallback

; 59   : 		wav_spec.userdata = NULL;

	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+56], 0

; 60   : 
; 61   : 		audio_pos = wav_buffer; // copy sound buffer

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+32]
	mov	DWORD PTR _audio_pos, ecx

; 62   : 		audio_len = wav_length; // copy file length

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+28]
	mov	DWORD PTR _audio_len, ecx

; 63   : 		SDL_OpenAudio(&wav_spec, NULL);
...
; 66   : 	else
	...
	jmp	SHORT $LN3@playAudio
$LN2@playAudio:

; 67   : 	{
; 68   : 		Mix_PlayMusic(gMusic, -1);
...
; 71   : }
	...
	pop	ebp
	ret	0
?playAudio@audio@aud@@QAEXXZ ENDP			; aud::audio::playAudio
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File f:\finished_projects\project_files\whitenoise\james robertson sdl final\sdl_game\sdl_game\audio.cpp
;	COMDAT ?loadAudio@audio@aud@@QAEXV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
_TEXT	SEGMENT
_this$ = -8						; size = 4
_file$ = 8						; size = 28
?loadAudio@audio@aud@@QAEXV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z PROC ; aud::audio::loadAudio, COMDAT
; _this$ = ecx
...
; 44   : 	if (sfx)
	...
	movzx	ecx, BYTE PTR [eax+64]
	test	ecx, ecx
	je	SHORT $LN2@loadAudio

; 45   : 	{
; 46   : 		gChunk = Mix_LoadWAV(file.c_str());
...
; 48   : 	else
	...
	jmp	SHORT $LN1@loadAudio
$LN2@loadAudio:

; 49   : 	{
; 50   : 		gMusic = Mix_LoadMUS(file.c_str());
...
; 52   : }
	...
	pop	ebp
	ret	28					; 0000001cH
?loadAudio@audio@aud@@QAEXV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z ENDP ; aud::audio::loadAudio
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File f:\finished_projects\project_files\whitenoise\james robertson sdl final\sdl_game\sdl_game\audio.cpp
;	COMDAT ?sfxSelect@audio@aud@@QAEX_N@Z
_TEXT	SEGMENT
_this$ = -8						; size = 4
_select$ = 8						; size = 1
?sfxSelect@audio@aud@@QAEX_N@Z PROC			; aud::audio::sfxSelect, COMDAT
; _this$ = ecx
...
; 27   : }
	...
	pop	ebp
	ret	4
?sfxSelect@audio@aud@@QAEX_N@Z ENDP			; aud::audio::sfxSelect
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File f:\finished_projects\project_files\whitenoise\james robertson sdl final\sdl_game\sdl_game\audio.cpp
;	COMDAT ??0audio@aud@@QAE@XZ
_TEXT	SEGMENT
_this$ = -8						; size = 4
??0audio@aud@@QAE@XZ PROC				; aud::audio::audio, COMDAT
; _this$ = ecx
...
; 23   : 
; 24   : void aud::audio::sfxSelect(bool select)
; 25   : {
; 26   : 	sfx = select;
; 27   : }
; 28   : 
; 29   : void aud::audioCallback(void *userdata, Uint8 *stream, int len)
; 30   : {
; 31   : 	if (audio_len == 0)
; 32   : 		return;
; 33   : 
; 34   : 	len = ((Uint8)len > audio_len ? audio_len : len);
; 35   : 	SDL_memcpy(stream, audio_pos, len); 					// simply copy from one buffer into the other
; 36   : 	SDL_MixAudio(stream, audio_pos, len, 33);// mix from one buffer into another
; 37   : 
...
; 16   : 	audio_pos = 0; // global pointer to the audio buffer to be played

	mov	DWORD PTR _audio_pos, 0

; 17   : 	audio_len = 0; // remaining length of the sample we have to play

	mov	DWORD PTR _audio_len, 0

; 18   : 	wav_length = 0; // length of our sample

	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+28], 0

; 19   : 	wav_buffer = 0; // buffer containing our audio file
...
; 22   : }
	...
	pop	ebp
	ret	0
??0audio@aud@@QAE@XZ ENDP				; aud::audio::audio
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File f:\finished_projects\project_files\whitenoise\james robertson sdl final\sdl_game\sdl_game\audio.cpp
;	COMDAT ?audioCallback@aud@@YAXPAXPAEH@Z
_TEXT	SEGMENT
tv67 = -196						; size = 4
_userdata$ = 8						; size = 4
_stream$ = 12						; size = 4
_len$ = 16						; size = 4
?audioCallback@aud@@YAXPAXPAEH@Z PROC			; aud::audioCallback, COMDAT
...
; 31   : 	if (audio_len == 0)
	...
	cmp	DWORD PTR _audio_len, 0
	jne	SHORT $LN1@audioCallb

; 32   : 		return;

	jmp	SHORT $LN2@audioCallb
$LN1@audioCallb:
...
; 34   : 	len = ((Uint8)len > audio_len ? audio_len : len);
	...
	cmp	eax, DWORD PTR _audio_len
	jbe	SHORT $LN4@audioCallb
	mov	ecx, DWORD PTR _audio_len
	mov	DWORD PTR tv67[ebp], ecx
	jmp	SHORT $LN5@audioCallb
$LN4@audioCallb:
...
; 38   : 	audio_pos += len;
	...
	mov	eax, DWORD PTR _audio_pos
	add	eax, DWORD PTR _len$[ebp]
	mov	DWORD PTR _audio_pos, eax

; 39   : 	audio_len -= len;

	mov	eax, DWORD PTR _audio_len
	sub	eax, DWORD PTR _len$[ebp]
	mov	DWORD PTR _audio_len, eax
$LN2@audioCallb:
...
; 40   : }
	...
	pop	ebp
	ret	0
?audioCallback@aud@@YAXPAXPAEH@Z ENDP			; aud::audioCallback
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
