; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.21005.1 
	...
	TITLE	F:\Finished_Projects\PROJECT_FILES\WhiteNoise\James Robertson SDL Final\SDL_Game\SDL_Game\PowerUp.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	ENDS
PUBLIC	??0PowerUp@gam@@QAE@XZ				; gam::PowerUp::PowerUp
PUBLIC	??1PowerUp@gam@@QAE@XZ				; gam::PowerUp::~PowerUp
PUBLIC	?spawnPowerUp@PowerUp@gam@@QAEXHH@Z		; gam::PowerUp::spawnPowerUp
PUBLIC	?movePowerUp@PowerUp@gam@@QAEXXZ		; gam::PowerUp::movePowerUp
PUBLIC	?drawPowerUp@PowerUp@gam@@QAEXPAUSDL_Renderer@@PAUSDL_Texture@@@Z ; gam::PowerUp::drawPowerUp
PUBLIC	?checkCollisions@PowerUp@gam@@QAE_NUSDL_Rect@@@Z ; gam::PowerUp::checkCollisions
PUBLIC	?erasePowerUp@PowerUp@gam@@QAEXXZ		; gam::PowerUp::erasePowerUp
PUBLIC	_hypot
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File f:\finished_projects\project_files\whitenoise\james robertson sdl final\sdl_game\sdl_game\powerup.cpp
;	COMDAT ?erasePowerUp@PowerUp@gam@@QAEXXZ
_TEXT	SEGMENT
_this$ = -8						; size = 4
?erasePowerUp@PowerUp@gam@@QAEXXZ PROC			; gam::PowerUp::erasePowerUp, COMDAT
; _this$ = ecx
...
; 91   : 	// Erase the start of the array
; 92   : 	//enemies.erase(enemies.begin());
; 93   : }
	...
	pop	ebp
	ret	0
?erasePowerUp@PowerUp@gam@@QAEXXZ ENDP			; gam::PowerUp::erasePowerUp
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File f:\finished_projects\project_files\whitenoise\james robertson sdl final\sdl_game\sdl_game\powerup.cpp
;	COMDAT ?checkCollisions@PowerUp@gam@@QAE_NUSDL_Rect@@@Z
_TEXT	SEGMENT
_this$ = -8						; size = 4
_ship$ = 8						; size = 16
?checkCollisions@PowerUp@gam@@QAE_NUSDL_Rect@@@Z PROC	; gam::PowerUp::checkCollisions, COMDAT
; _this$ = ecx
...
; 76   : 	// Check with the bullet that has been passed through
; 77   : 	if (SDL_HasIntersection(&PowerUpRect, &ship))
...
; 78   : 	{
; 79   : 		// If hit, Teleport PowerUp off screen
; 80   : 		PowerUpRect.y = 2000;

	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+8], 2000			; 000007d0H

; 81   : 		return true;

	mov	al, 1
	jmp	SHORT $LN2@checkColli
$LN1@checkColli:
...
; 84   : }
	...
	pop	ebp
	ret	16					; 00000010H
?checkCollisions@PowerUp@gam@@QAE_NUSDL_Rect@@@Z ENDP	; gam::PowerUp::checkCollisions
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File f:\finished_projects\project_files\whitenoise\james robertson sdl final\sdl_game\sdl_game\powerup.cpp
;	COMDAT ?drawPowerUp@PowerUp@gam@@QAEXPAUSDL_Renderer@@PAUSDL_Texture@@@Z
_TEXT	SEGMENT
_this$ = -8						; size = 4
_Renderer$ = 8						; size = 4
_Bullet$ = 12						; size = 4
?drawPowerUp@PowerUp@gam@@QAEXPAUSDL_Renderer@@PAUSDL_Texture@@@Z PROC ; gam::PowerUp::drawPowerUp, COMDAT
; _this$ = ecx
...
; 66   : 	// Draw onto the screen
; 67   : 	SDL_QueryTexture(Bullet, NULL, NULL, &PowerUpRect.w, &PowerUpRect.h);
...
; 68   : 	SDL_RenderCopy(Renderer, Bullet, NULL, &PowerUpRect);
...
; 69   : }
	...
	pop	ebp
	ret	8
?drawPowerUp@PowerUp@gam@@QAEXPAUSDL_Renderer@@PAUSDL_Texture@@@Z ENDP ; gam::PowerUp::drawPowerUp
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File f:\finished_projects\project_files\whitenoise\james robertson sdl final\sdl_game\sdl_game\powerup.cpp
;	COMDAT ?movePowerUp@PowerUp@gam@@QAEXXZ
_TEXT	SEGMENT
_this$ = -8						; size = 4
?movePowerUp@PowerUp@gam@@QAEXXZ PROC			; gam::PowerUp::movePowerUp, COMDAT
; _this$ = ecx
...
; 49   : 
; 50   : 	// Move the PowerUp "South - East"
; 51   : 	PowerUpRect.y += velocity;
...
; 52   : 
; 53   : 	// If they're off screen delete them!
; 54   : 	if (PowerUpRect.y > 1700)

	mov	eax, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [eax+8], 1700			; 000006a4H
	jle	SHORT $LN2@movePowerU
...
; 59   : }
	...
	pop	ebp
	ret	0
?movePowerUp@PowerUp@gam@@QAEXXZ ENDP			; gam::PowerUp::movePowerUp
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File f:\finished_projects\project_files\whitenoise\james robertson sdl final\sdl_game\sdl_game\powerup.cpp
;	COMDAT ?spawnPowerUp@PowerUp@gam@@QAEXHH@Z
_TEXT	SEGMENT
_temp$ = -36						; size = 16
_this$ = -12						; size = 4
...
_x$ = 8							; size = 4
_y$ = 12						; size = 4
?spawnPowerUp@PowerUp@gam@@QAEXHH@Z PROC		; gam::PowerUp::spawnPowerUp, COMDAT
; _this$ = ecx
...
; 30   : 	// Temp Rect to push to the vector
; 31   : 	SDL_Rect temp;
; 32   : 
; 33   : 	// Assign the values to the ones that were passed through
; 34   : 	temp.x = x;
...
; 38   : 
; 39   : 	///int random = rand() % 800;
; 40   : 	/// Place different patterns here that spawn - Type
; 41   : 	/// Case statement here with random basing the outcome every 15 seconds (?) - That will be passed through - or called through main
; 42   : }

	push	edx
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN5@spawnPower
	call	@_RTC_CheckStackVars@8
	pop	eax
	pop	edx
	pop	edi
...
$LN3@spawnPower:
	...
	DB	112					; 00000070H
	DB	0
?spawnPowerUp@PowerUp@gam@@QAEXHH@Z ENDP		; gam::PowerUp::spawnPowerUp
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File f:\finished_projects\project_files\whitenoise\james robertson sdl final\sdl_game\sdl_game\powerup.cpp
;	COMDAT ??1PowerUp@gam@@QAE@XZ
_TEXT	SEGMENT
_this$ = -8						; size = 4
??1PowerUp@gam@@QAE@XZ PROC				; gam::PowerUp::~PowerUp, COMDAT
; _this$ = ecx
...
; 24   : }
	...
	pop	ebp
	ret	0
??1PowerUp@gam@@QAE@XZ ENDP				; gam::PowerUp::~PowerUp
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File f:\finished_projects\project_files\whitenoise\james robertson sdl final\sdl_game\sdl_game\powerup.cpp
;	COMDAT ??0PowerUp@gam@@QAE@XZ
_TEXT	SEGMENT
_this$ = -8						; size = 4
??0PowerUp@gam@@QAE@XZ PROC				; gam::PowerUp::PowerUp, COMDAT
; _this$ = ecx
...
; 19   : }
	...
	pop	ebp
	ret	0
??0PowerUp@gam@@QAE@XZ ENDP				; gam::PowerUp::PowerUp
_TEXT	ENDS
END
