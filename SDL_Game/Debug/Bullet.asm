; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.21005.1 
	...
	TITLE	F:\Finished_Projects\PROJECT_FILES\WhiteNoise\James Robertson SDL Final\SDL_Game\SDL_Game\Bullet.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??0bullet@gam@@QAE@XZ				; gam::bullet::bullet
PUBLIC	?spawnBullet@bullet@gam@@QAEXHH@Z		; gam::bullet::spawnBullet
PUBLIC	?moveBullets@bullet@gam@@QAEXXZ			; gam::bullet::moveBullets
PUBLIC	?drawBullets@bullet@gam@@QAEXPAUSDL_Renderer@@PAUSDL_Texture@@@Z ; gam::bullet::drawBullets
PUBLIC	?eraseBullets@bullet@gam@@QAEXXZ		; gam::bullet::eraseBullets
PUBLIC	?throwBullets@bullet@gam@@QAEXE@Z		; gam::bullet::throwBullets
PUBLIC	?getBullet@bullet@gam@@QAE?AUSDL_Rect@@E@Z	; gam::bullet::getBullet
PUBLIC	?amountOfBullets@bullet@gam@@QAEEXZ		; gam::bullet::amountOfBullets
...
;	COMDAT xdata$x
xdata$x	SEGMENT
__unwindtable$?eraseBullets@bullet@gam@@QAEXXZ DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?eraseBullets@bullet@gam@@QAEXXZ$0
__ehfuncinfo$?eraseBullets@bullet@gam@@QAEXXZ DD 019930522H
	DD	01H
	DD	FLAT:__unwindtable$?eraseBullets@bullet@gam@@QAEXXZ
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File f:\finished_projects\project_files\whitenoise\james robertson sdl final\sdl_game\sdl_game\bullet.cpp
;	COMDAT ?amountOfBullets@bullet@gam@@QAEEXZ
_TEXT	SEGMENT
_amount$ = -17						; size = 1
_this$ = -8						; size = 4
?amountOfBullets@bullet@gam@@QAEEXZ PROC		; gam::bullet::amountOfBullets, COMDAT
; _this$ = ecx
...
; 98   : 	// Set to temp variable and then return it
; 99   : 	uint8_t amount = (uint8_t)bullets.size();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?size@?$vector@USDL_Rect@@V?$allocator@USDL_Rect@@@std@@@std@@QBEIXZ ; std::vector<SDL_Rect,std::allocator<SDL_Rect> >::size
	mov	BYTE PTR _amount$[ebp], al

; 100  : 	return amount;

	mov	al, BYTE PTR _amount$[ebp]
...
; 101  : }
	...
	pop	ebp
	ret	0
?amountOfBullets@bullet@gam@@QAEEXZ ENDP		; gam::bullet::amountOfBullets
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File f:\finished_projects\project_files\whitenoise\james robertson sdl final\sdl_game\sdl_game\bullet.cpp
;	COMDAT ?getBullet@bullet@gam@@QAE?AUSDL_Rect@@E@Z
_TEXT	SEGMENT
_this$ = -8						; size = 4
___$ReturnUdt$ = 8					; size = 4
_index$ = 12						; size = 1
?getBullet@bullet@gam@@QAE?AUSDL_Rect@@E@Z PROC		; gam::bullet::getBullet, COMDAT
; _this$ = ecx
...
; 89   : 	// Return the bullet that has been requested
; 90   : 	return bullets[index];
...
; 91   : }
	...
	pop	ebp
	ret	8
?getBullet@bullet@gam@@QAE?AUSDL_Rect@@E@Z ENDP		; gam::bullet::getBullet
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File f:\finished_projects\project_files\whitenoise\james robertson sdl final\sdl_game\sdl_game\bullet.cpp
;	COMDAT ?throwBullets@bullet@gam@@QAEXE@Z
_TEXT	SEGMENT
_this$ = -8						; size = 4
_index$ = 8						; size = 1
?throwBullets@bullet@gam@@QAEXE@Z PROC			; gam::bullet::throwBullets, COMDAT
; _this$ = ecx
...
; 81   : 	bullets[index].x = 2500;

	movzx	eax, BYTE PTR _index$[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	??A?$vector@USDL_Rect@@V?$allocator@USDL_Rect@@@std@@@std@@QAEAAUSDL_Rect@@I@Z ; std::vector<SDL_Rect,std::allocator<SDL_Rect> >::operator[]
	mov	DWORD PTR [eax], 2500			; 000009c4H
...
; 82   : }
	...
	pop	ebp
	ret	4
?throwBullets@bullet@gam@@QAEXE@Z ENDP			; gam::bullet::throwBullets
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File f:\finished_projects\project_files\whitenoise\james robertson sdl final\sdl_game\sdl_game\bullet.cpp
;	COMDAT ?eraseBullets@bullet@gam@@QAEXXZ
_TEXT	SEGMENT
tv129 = -284						; size = 4
tv128 = -280						; size = 4
tv94 = -276						; size = 4
...
_this$ = -20						; size = 4
__$EHRec$ = -12						; size = 12
?eraseBullets@bullet@gam@@QAEXXZ PROC			; gam::bullet::eraseBullets, COMDAT
; _this$ = ecx
...
; 74   : {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$?eraseBullets@bullet@gam@@QAEXXZ
	mov	eax, DWORD PTR fs:0
	push	eax
...
; 75   : 	// Erase the beginning of the vector
; 76   : 	bullets.erase(bullets.begin());
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$?eraseBullets@bullet@gam@@QAEXXZ$0:
	lea	ecx, DWORD PTR $T3[ebp]
	jmp	??1?$_Vector_iterator@V?$_Vector_val@U?$_Simple_types@USDL_Rect@@@std@@@std@@@std@@QAE@XZ
__ehhandler$?eraseBullets@bullet@gam@@QAEXXZ:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-288]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?eraseBullets@bullet@gam@@QAEXXZ
	jmp	___CxxFrameHandler3
text$x	ENDS
?eraseBullets@bullet@gam@@QAEXXZ ENDP			; gam::bullet::eraseBullets
; Function compile flags: /Odtp /RTCsu /ZI
; File f:\finished_projects\project_files\whitenoise\james robertson sdl final\sdl_game\sdl_game\bullet.cpp
;	COMDAT ?drawBullets@bullet@gam@@QAEXPAUSDL_Renderer@@PAUSDL_Texture@@@Z
_TEXT	SEGMENT
_i$1 = -20						; size = 4
_this$ = -8						; size = 4
_Renderer$ = 8						; size = 4
_Bullet$ = 12						; size = 4
?drawBullets@bullet@gam@@QAEXPAUSDL_Renderer@@PAUSDL_Texture@@@Z PROC ; gam::bullet::drawBullets, COMDAT
; _this$ = ecx
...
; 61   : 	// Loop through each bullet
; 62   : 	for (size_t i = 0; i < bullets.size(); i++)

	mov	DWORD PTR _i$1[ebp], 0
	jmp	SHORT $LN3@drawBullet
$LN2@drawBullet:
...
$LN3@drawBullet:
	...
	jae	SHORT $LN4@drawBullet

; 63   : 	{
; 64   : 		// Draw them to the renderer
; 65   : 		SDL_QueryTexture(Bullet, NULL, NULL, &bullets[i].w, &bullets[i].h);
...
; 66   : 		SDL_RenderCopy(Renderer, Bullet, NULL, &bullets[i]);
...
; 68   : }
	...
	pop	ebp
	ret	8
?drawBullets@bullet@gam@@QAEXPAUSDL_Renderer@@PAUSDL_Texture@@@Z ENDP ; gam::bullet::drawBullets
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File f:\finished_projects\project_files\whitenoise\james robertson sdl final\sdl_game\sdl_game\bullet.cpp
;	COMDAT ?moveBullets@bullet@gam@@QAEXXZ
_TEXT	SEGMENT
tv76 = -220						; size = 4
_i$1 = -20						; size = 4
_this$ = -8						; size = 4
?moveBullets@bullet@gam@@QAEXXZ PROC			; gam::bullet::moveBullets, COMDAT
; _this$ = ecx
...
; 42   : 	// Go through the Vector of Bullets
; 43   : 	for (size_t i = 0; i < bullets.size(); i++)

	mov	DWORD PTR _i$1[ebp], 0
	jmp	SHORT $LN4@moveBullet
$LN3@moveBullet:
	mov	eax, DWORD PTR _i$1[ebp]
	add	eax, 1
	mov	DWORD PTR _i$1[ebp], eax
$LN4@moveBullet:
	...
	call	?size@?$vector@USDL_Rect@@V?$allocator@USDL_Rect@@@std@@@std@@QBEIXZ ; std::vector<SDL_Rect,std::allocator<SDL_Rect> >::size
	cmp	DWORD PTR _i$1[ebp], eax
	jae	SHORT $LN5@moveBullet

; 44   : 	{
; 45   : 		// Move with velocity
; 46   : 		bullets[i].y -= velocity;
...
; 47   : 
; 48   : 		// Delete if off screen
; 49   : 		if (bullets[i].y < -10)

	mov	eax, DWORD PTR _i$1[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	??A?$vector@USDL_Rect@@V?$allocator@USDL_Rect@@@std@@@std@@QAEAAUSDL_Rect@@I@Z ; std::vector<SDL_Rect,std::allocator<SDL_Rect> >::operator[]
	cmp	DWORD PTR [eax+4], -10			; fffffff6H
	jge	SHORT $LN1@moveBullet

; 50   : 		{
; 51   : 			eraseBullets();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?eraseBullets@bullet@gam@@QAEXXZ	; gam::bullet::eraseBullets
$LN1@moveBullet:

; 52   : 		}
; 53   : 	}

	jmp	SHORT $LN3@moveBullet
$LN5@moveBullet:
...
; 54   : }
	...
	pop	ebp
	ret	0
?moveBullets@bullet@gam@@QAEXXZ ENDP			; gam::bullet::moveBullets
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File f:\finished_projects\project_files\whitenoise\james robertson sdl final\sdl_game\sdl_game\bullet.cpp
;	COMDAT ?spawnBullet@bullet@gam@@QAEXHH@Z
_TEXT	SEGMENT
_temp$ = -36						; size = 16
_this$ = -12						; size = 4
...
_ships_x$ = 8						; size = 4
_ships_y$ = 12						; size = 4
?spawnBullet@bullet@gam@@QAEXHH@Z PROC			; gam::bullet::spawnBullet, COMDAT
; _this$ = ecx
...
; 26   : 	// Create a temp Rect to push back
; 27   : 	SDL_Rect temp;
; 28   : 
; 29   : 	// Assign the passed in values
; 30   : 	temp.x = ships_x + 70;

	mov	eax, DWORD PTR _ships_x$[ebp]
	add	eax, 70					; 00000046H
	mov	DWORD PTR _temp$[ebp], eax

; 31   : 	temp.y = ships_y + 10;

	mov	eax, DWORD PTR _ships_y$[ebp]
	add	eax, 10					; 0000000aH
	mov	DWORD PTR _temp$[ebp+4], eax

; 32   : 
; 33   : 	// Push it to the vector
; 34   : 	bullets.push_back(temp);
...
; 35   : }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN5@spawnBulle
	call	@_RTC_CheckStackVars@8
	pop	eax
	pop	edx
	pop	edi
...
$LN3@spawnBulle:
	...
	DB	112					; 00000070H
	DB	0
?spawnBullet@bullet@gam@@QAEXHH@Z ENDP			; gam::bullet::spawnBullet
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File f:\finished_projects\project_files\whitenoise\james robertson sdl final\sdl_game\sdl_game\bullet.cpp
;	COMDAT ??0bullet@gam@@QAE@XZ
_TEXT	SEGMENT
_this$ = -8						; size = 4
??0bullet@gam@@QAE@XZ PROC				; gam::bullet::bullet, COMDAT
; _this$ = ecx
...
; 18   : 	velocity = 21;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	BYTE PTR [eax+16], 21			; 00000015H
...
; 19   : }
	...
	pop	ebp
	ret	0
??0bullet@gam@@QAE@XZ ENDP				; gam::bullet::bullet
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\program files (x86)\microsoft visual studio 12.0\vc\include\xutility
