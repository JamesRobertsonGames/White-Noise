; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.21005.1 
	...
	TITLE	F:\Finished_Projects\PROJECT_FILES\WhiteNoise\James Robertson SDL Final\SDL_Game\SDL_Game\Controller.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?CheckControllerStatus@@YAXAAUSDL_Rect@@AAU_XINPUT_STATE@@AAMAAVbullet@gam@@E@Z ; CheckControllerStatus
PUBLIC	?controllerIsConnected@@YA_NAAU_XINPUT_STATE@@AAU_XINPUT_VIBRATION@@@Z ; controllerIsConnected
PUBLIC	?vibrate@@YAXNN@Z				; vibrate
PUBLIC	?movement@@YAXAAUSDL_Rect@@AAU_XINPUT_STATE@@@Z	; movement
...
PUBLIC	__real@3ecd5c31593e5fb7
PUBLIC	__real@3ed0c6f7a0b5ed8d
...
CONST	ENDS
;	COMDAT __real@3ed0c6f7a0b5ed8d
CONST	SEGMENT
__real@3ed0c6f7a0b5ed8d DQ 03ed0c6f7a0b5ed8dr	; 4e-006
CONST	ENDS
;	COMDAT __real@3ecd5c31593e5fb7
CONST	SEGMENT
__real@3ecd5c31593e5fb7 DQ 03ecd5c31593e5fb7r	; 3.5e-006
CONST	ENDS
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File f:\finished_projects\project_files\whitenoise\james robertson sdl final\sdl_game\sdl_game\controller.cpp
;	COMDAT ?movement@@YAXAAUSDL_Rect@@AAU_XINPUT_STATE@@@Z
_TEXT	SEGMENT
_DEADZONE$ = -24					; size = 2
_playerOne$ = -12					; size = 8
_player$ = 8						; size = 4
_state$ = 12						; size = 4
?movement@@YAXAAUSDL_Rect@@AAU_XINPUT_STATE@@@Z PROC	; movement, COMDAT
...
; 72   : 	// Make this into a class probably though I do not see the plus points in doing this
; 73   : 	struct controllerSticks
; 74   : 	{
; 75   : 		int16_t leftStick_Y;
; 76   : 		int16_t leftStick_X;
; 77   : 		int16_t rightStick_Y;
; 78   : 		int16_t rightStick_X;
; 79   : 	}playerOne;
; 80   : 	// Get all the current states of controller 1
; 81   : 	XInputGetState(0, &state);

	mov	eax, DWORD PTR _state$[ebp]
	push	eax
	push	0
	call	_XInputGetState@8

; 82   : 
; 83   : 	// Set both stick variables and attach them to the input
; 84   : 	playerOne.leftStick_Y = state.Gamepad.sThumbLY;

	mov	eax, DWORD PTR _state$[ebp]
	mov	cx, WORD PTR [eax+10]
	mov	WORD PTR _playerOne$[ebp], cx

; 85   : 	playerOne.leftStick_X = state.Gamepad.sThumbLX;

	mov	eax, DWORD PTR _state$[ebp]
	mov	cx, WORD PTR [eax+8]
	mov	WORD PTR _playerOne$[ebp+2], cx

; 86   : 
; 87   : 	// Set the Deadzones for the stick
; 88   : 	const int16_t DEADZONE = 5000;

	mov	eax, 5000				; 00001388H
	mov	WORD PTR _DEADZONE$[ebp], ax

; 89   : 
; 90   : 	// Deadzone Setting
; 91   : 	if (state.Gamepad.sThumbLY < DEADZONE && state.Gamepad.sThumbLY > -DEADZONE)

	mov	eax, DWORD PTR _state$[ebp]
	movsx	ecx, WORD PTR [eax+10]
	cmp	ecx, 5000				; 00001388H
	jge	SHORT $LN8@movement
	mov	eax, DWORD PTR _state$[ebp]
	movsx	ecx, WORD PTR [eax+10]
	cmp	ecx, -5000				; ffffec78H
	jle	SHORT $LN8@movement

; 92   : 	{
; 93   : 		playerOne.leftStick_Y = 0;

	xor	eax, eax
	mov	WORD PTR _playerOne$[ebp], ax
$LN8@movement:

; 94   : 	}
; 95   : 
; 96   : 	if (state.Gamepad.sThumbLX < DEADZONE && state.Gamepad.sThumbLX > -DEADZONE)

	mov	eax, DWORD PTR _state$[ebp]
	movsx	ecx, WORD PTR [eax+8]
	cmp	ecx, 5000				; 00001388H
	jge	SHORT $LN7@movement
	mov	eax, DWORD PTR _state$[ebp]
	movsx	ecx, WORD PTR [eax+8]
	cmp	ecx, -5000				; ffffec78H
	jle	SHORT $LN7@movement

; 97   : 	{
; 98   : 		playerOne.leftStick_X = 0;

	xor	eax, eax
	mov	WORD PTR _playerOne$[ebp+2], ax
$LN7@movement:

; 99   : 	}
; 100  : 
; 101  : 	// If the value is out of the dead zone then work!
; 102  : 	if (playerOne.leftStick_Y != 0)

	movsx	eax, WORD PTR _playerOne$[ebp]
	test	eax, eax
	je	$LN4@movement

; 103  : 	{
; 104  : 		player.y -= playerOne.leftStick_Y / 2000;
...
; 105  : 		vibrate(abs(playerOne.leftStick_Y) * 0.000004, abs(playerOne.leftStick_Y) * 0.000004);
	...
	add	esp, 4
	cvtsi2sd xmm0, eax
	mulsd	xmm0, QWORD PTR __real@3ed0c6f7a0b5ed8d
	sub	esp, 8
	movsd	QWORD PTR [esp], xmm0
	movsx	ecx, WORD PTR _playerOne$[ebp]
	push	ecx
	call	_abs
	add	esp, 4
	cvtsi2sd xmm0, eax
...
; 107  : 		if (player.y >= 940)
	...
	cmp	DWORD PTR [eax+4], 940			; 000003acH
	jl	SHORT $LN5@movement

; 108  : 		{
; 109  : 			player.y = 938;

	mov	eax, DWORD PTR _player$[ebp]
	mov	DWORD PTR [eax+4], 938			; 000003aaH
$LN5@movement:
...
; 112  : 		if (player.y <= 110)
	...
	mov	eax, DWORD PTR _player$[ebp]
	cmp	DWORD PTR [eax+4], 110			; 0000006eH
	jg	SHORT $LN4@movement

; 113  : 		{
; 114  : 			player.y = 112;

	mov	eax, DWORD PTR _player$[ebp]
	mov	DWORD PTR [eax+4], 112			; 00000070H
$LN4@movement:

; 115  : 		}
; 116  : 	}
; 117  : 
; 118  : 	// If the value is out of the dead zone then work!
; 119  : 	if (playerOne.leftStick_X != 0)

	movsx	eax, WORD PTR _playerOne$[ebp+2]
	test	eax, eax
	je	$LN1@movement

; 120  : 	{
; 121  : 		player.x += playerOne.leftStick_X / 2000;
...
; 122  : 		vibrate(abs(playerOne.leftStick_X) * 0.0000035, abs(playerOne.leftStick_X) * 0.0000035);
	...
	add	esp, 4
	cvtsi2sd xmm0, eax
	mulsd	xmm0, QWORD PTR __real@3ecd5c31593e5fb7
	sub	esp, 8
	movsd	QWORD PTR [esp], xmm0
	movsx	ecx, WORD PTR _playerOne$[ebp+2]
	push	ecx
	call	_abs
	add	esp, 4
	cvtsi2sd xmm0, eax
...
; 123  : 
; 124  : 		if (player.x >= 1800)

	mov	eax, DWORD PTR _player$[ebp]
	cmp	DWORD PTR [eax], 1800			; 00000708H
	jl	SHORT $LN2@movement

; 125  : 		{
; 126  : 			player.x = 1798;

	mov	eax, DWORD PTR _player$[ebp]
	mov	DWORD PTR [eax], 1798			; 00000706H
$LN2@movement:
...
; 135  : }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN13@movement
...
$LN11@movement:
	...
	DB	101					; 00000065H
	DB	0
?movement@@YAXAAUSDL_Rect@@AAU_XINPUT_STATE@@@Z ENDP	; movement
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File f:\finished_projects\project_files\whitenoise\james robertson sdl final\sdl_game\sdl_game\controller.cpp
;	COMDAT ?vibrate@@YAXNN@Z
_TEXT	SEGMENT
_rightVib$ = -32					; size = 2
_leftVib$ = -20						; size = 2
_Vibration$ = -8					; size = 4
_leftmotor$ = 8						; size = 8
_rightmotor$ = 16					; size = 8
?vibrate@@YAXNN@Z PROC					; vibrate, COMDAT
...
; 50   : 	// Create a new Vibraton 
; 51   : 	XINPUT_VIBRATION Vibration;
; 52   : 
; 53   : 	// Set first num bytes to block of memory (I Have no clue)
; 54   : 	memset(&Vibration, 0, sizeof(XINPUT_VIBRATION));
...
; 55   : 
; 56   : 	// Vibrate amount
; 57   : 	WORD leftVib = (WORD)(leftmotor*65535.0f);

	movsd	xmm0, QWORD PTR _leftmotor$[ebp]
	mulsd	xmm0, QWORD PTR __real@40efffe000000000
	cvttsd2si eax, xmm0
	mov	WORD PTR _leftVib$[ebp], ax

; 58   : 	WORD rightVib = (WORD)(rightmotor*65535.0f);

	movsd	xmm0, QWORD PTR _rightmotor$[ebp]
	mulsd	xmm0, QWORD PTR __real@40efffe000000000
	cvttsd2si eax, xmm0
	mov	WORD PTR _rightVib$[ebp], ax

; 59   : 
; 60   : 	// Set the Vibration Values
; 61   : 	Vibration.wLeftMotorSpeed = leftVib;

	mov	ax, WORD PTR _leftVib$[ebp]
	mov	WORD PTR _Vibration$[ebp], ax

; 62   : 	Vibration.wRightMotorSpeed = rightVib;

	mov	ax, WORD PTR _rightVib$[ebp]
	mov	WORD PTR _Vibration$[ebp+2], ax

; 63   : 
; 64   : 	// Vibrate the controller
; 65   : 	XInputSetState((int)0, &Vibration);

	lea	eax, DWORD PTR _Vibration$[ebp]
	push	eax
	push	0
	call	_XInputSetState@8
...
$LN3@vibrate:
	...
	DB	110					; 0000006eH
	DB	0
?vibrate@@YAXNN@Z ENDP					; vibrate
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File f:\finished_projects\project_files\whitenoise\james robertson sdl final\sdl_game\sdl_game\controller.cpp
;	COMDAT ?controllerIsConnected@@YA_NAAU_XINPUT_STATE@@AAU_XINPUT_VIBRATION@@@Z
_TEXT	SEGMENT
_dvResult$ = -20					; size = 4
_dwResult$ = -8						; size = 4
_controller$ = 8					; size = 4
_vibration$ = 12					; size = 4
?controllerIsConnected@@YA_NAAU_XINPUT_STATE@@AAU_XINPUT_VIBRATION@@@Z PROC ; controllerIsConnected, COMDAT
...
; 19   : 	// Store if the controller is connected
; 20   : 	DWORD dwResult;
; 21   : 	DWORD dvResult;
; 22   : 
; 23   : 	// Zeros all memory values in the controller
; 24   : 	ZeroMemory(&controller, sizeof(XINPUT_STATE));
...
; 25   : 
; 26   : 	// Get the current state of controller 1
; 27   : 	dwResult = XInputGetState(0, &controller);
...
; 28   : 
; 29   : 	// Zeros all the memory values in the vibration modual
; 30   : 	ZeroMemory(&vibration, sizeof(XINPUT_VIBRATION));

	push	4
	push	0
	mov	eax, DWORD PTR _vibration$[ebp]
	push	eax
	call	_memset
	add	esp, 12					; 0000000cH

; 31   : 
; 32   : 	// Set the state of the vibration moduel
; 33   : 	dvResult = XInputSetState(0, &vibration);

	mov	eax, DWORD PTR _vibration$[ebp]
	push	eax
	push	0
	call	_XInputSetState@8
	mov	DWORD PTR _dvResult$[ebp], eax

; 34   : 
; 35   : 	// If it worked return true if not then its not connected
; 36   : 	if (dwResult == ERROR_SUCCESS && dvResult == ERROR_SUCCESS)

	cmp	DWORD PTR _dwResult$[ebp], 0
	jne	SHORT $LN2@controller
	cmp	DWORD PTR _dvResult$[ebp], 0
	jne	SHORT $LN2@controller
...
; 44   : }
	...
	pop	ebp
	ret	0
?controllerIsConnected@@YA_NAAU_XINPUT_STATE@@AAU_XINPUT_VIBRATION@@@Z ENDP ; controllerIsConnected
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File f:\finished_projects\project_files\whitenoise\james robertson sdl final\sdl_game\sdl_game\controller.cpp
;	COMDAT ?CheckControllerStatus@@YAXAAUSDL_Rect@@AAU_XINPUT_STATE@@AAMAAVbullet@gam@@E@Z
_TEXT	SEGMENT
_player$ = 8						; size = 4
_state$ = 12						; size = 4
_timer$ = 16						; size = 4
_Bullet$ = 20						; size = 4
_bulletAmount$ = 24					; size = 1
?CheckControllerStatus@@YAXAAUSDL_Rect@@AAU_XINPUT_STATE@@AAMAAVbullet@gam@@E@Z PROC ; CheckControllerStatus, COMDAT
...
; 141  : 	// Button Checks Here
; 142  : 	if (timer > bulletAmount)
	...
	comiss	xmm1, xmm0
	jbe	SHORT $LN1@CheckContr

; 143  : 	{
; 144  : 		if (state.Gamepad.wButtons & XINPUT_GAMEPAD_A)

	mov	eax, DWORD PTR _state$[ebp]
	movzx	ecx, WORD PTR [eax+4]
	and	ecx, 4096				; 00001000H
	je	SHORT $LN1@CheckContr

; 145  : 		{
; 146  : 			Bullet.spawnBullet(player.x, player.y);
...
; 148  : 		}
; 149  : 	}
; 150  : 	// Set the movement off!
; 151  : 	movement(player, state);

	mov	eax, DWORD PTR _state$[ebp]
	push	eax
	mov	ecx, DWORD PTR _player$[ebp]
	push	ecx
	call	?movement@@YAXAAUSDL_Rect@@AAU_XINPUT_STATE@@@Z ; movement
	add	esp, 8
...
; 152  : }
	...
	pop	ebp
	ret	0
?CheckControllerStatus@@YAXAAUSDL_Rect@@AAU_XINPUT_STATE@@AAMAAVbullet@gam@@E@Z ENDP ; CheckControllerStatus
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
